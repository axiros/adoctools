...
server_url = 'https://axc2.axiros.com/asciidoctor'
// CAUTION: server cors necessary!
// location /asciidoctor {
...
function make_theme_switchers() {
    ...
    let f, o, skin_name, ak, skins, cur_theme, switcher, dropdown, typ, m, d
    types = ['adoc', 'code']
    for (let j = 0; j < 2; j++) {
        typ = types[j]
...
function set_theme(theme, typ) {
    ...
    if (!theme) {
        url = byid(th.ext_id)
        // this all only works when he has NOT set a working css style,
        // he must set to non existing:.. actually no. since we INSERT the css, the
        // extension one is not respected anymore, like it was when setting href :-)
        // if (
        //     false &&
        //     typ == 'adoc' &&
        //     url &&
        //     url.href &&
        //     url.href.indexOf('chrome-extension') > -1
        // )
        //     return
        //
        //     theme given in URL?:
    ...
    r.open(
        'GET',
        'https://raw.githubusercontent.com/AXGKl/productivity/master/foo.css',
    )
    r.send()
    //}
}
...
function make_css_container_elmt() {
    if (D.axattrs.tocleft) {
        ...
        var css = `#toc {z-index:1000;top:10em!important; right:0em!important; float:none; display:block!important; position:fixed!important}
        @media only screen and (min-width:1280px){
            #toc {top:0em!important;overflow:auto;width:15em;left:0em!important;}
            #content {margin-right:0!important;margin-left:auto!important}}
        @media only screen and (min-width:1500px){
            #toc {width:20em;left:2em!important;}
            #content {margin-right:5em!important;}}
        @media only screen and (min-width:1750px){
            #content {margin-right:auto!important;}}
        #switchers {width: 17em; position:fixed; bottom: 0em; left: 0em; white-space: nowrap;}
        .highlight {background-color: inherit!important; border: 0!important}
        `
...
`
    D.axattrs = {tocleft: is_set(':toc: left'), themes: is_set(':themes:')}
