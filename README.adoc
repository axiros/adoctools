...
This project tries to help make the viewing experience a bit bitter, for the `.adoc` format.
...
image:ex_ma_teal.png[dark, 400]
image:ex_noteboo.png[dark, 400]
image:ex_boot_sl.png[dark, 400]
image:ex_gazette.png[dark, 400]
...
We cannot inject custom styles into the document though, i.e. the page will be rendered using the style which is configured in the extension incl. its code style.
